...
def draw_hollow_O(tartaruga, x, y, outer_radius, inner_radius, color="black"):
    """
...
def draw_l(tartaruga, x, y, width, height, color="black"):
    """
    Desenha a letra "L".
...
def draw_lambda_A(tartaruga, x, y, size, thickness, color="black"):
    """
...
def draw_accent(tartaruga, x, y, length, thickness, color="black"):
    """
...
def draw_m(tartaruga, x, y, size, color="black"):
    """
    Desenha a letra "M".
...
def draw_u(tartaruga, x, y, size, color="black"):
    """
    Desenha a letra "U".
...
def draw_n(tartaruga, x, y, size, color="black"):
    """
    Desenha a letra "N".
...
def draw_d(tartaruga, x, y, size, color="black"):
    """
    Desenha a letra "D".
...
def draw_exclamation(tartaruga, x, y, size, color="black"):
    """
